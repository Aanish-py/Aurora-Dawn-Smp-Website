...
const LogoLoop = () => {
    ...
    return (
        <div className="w-full overflow-hidden py-10 bg-gradient-to-r from-black/20 via-black/30 to-black/20 backdrop-blur-sm border-y border-white/5 z-20 relative">
            ...
            <div className="flex gap-8 logo-loop-container group">
                {/* First set */}
                <div className="flex gap-8 logo-loop-track">
                    {items.map((social, i) => {
                        ...
                        return (
                            <a
                                ...
                                className="flex flex-col items-center justify-center gap-3 px-8 py-5 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 hover:border-aurora-green/50 hover:scale-110 hover:-translate-y-2 transition-all duration-300 cursor-pointer group/item min-w-[140px]"
                                style={{
                            ...
                            >
                                ...
                                <div className="flex flex-col items-center gap-1">
                                    <span className="text-sm font-bold text-white/90 group-hover/item:text-aurora-green transition-colors duration-300">
                                        {social.name}
                                    </span>
                                    {social.label && (
                ...
                <div className="flex gap-8 logo-loop-track" aria-hidden="true">
                    {items.map((social, i) => {
                        const Icon = social.icon;
                        return (
                            <a
